...
<div class="art-content-layout layout-item-1">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 15%;">
      <p><img width="144" height="164" alt="" src="./images/k.jpg" /><br /></p>
	...
	<div class="art-layout-cell layout-item-2" style="width: 40%;">
				...
				String mail=request.getParameter("mail");
				 ...
				 st.executeUpdate("insert into feedbacks values("+cardnum+",'"+name+"',"+phone+",'"+mail+"','"+problem+"')");
				 
				 %>
				 <font size="4" color="blue">FEDD BACK SEND SUCCESSFULLY</font>
      </div>
