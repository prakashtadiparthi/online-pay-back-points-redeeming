...
<head>
    ...
    <link rel="stylesheet" href="style9.css" type="text/css" media="screen" />
...
<div id="art-main">
  <div class="cleared reset-box"></div>
    <div class="art-box art-sheet">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		FEED BACK</font>           
<form method="post" name="f" onsubmit="return check()" action="feedbacksend.jsp">                  
				  <table border="2">
	
	<%
	String cardnum="",name="",phone="",mail="";
   ...
   while(rs.next())
        {
		  ...
		  mail=rs.getString(4);
		%>
	   <tr><th>pay card number:</th><td><input type="text" name="cardnum" value="<%=cardnum%>"></td></tr>
	   <tr><th>Name:</th><td><input type="text" name="name" value="<%=name%>"></td></tr>
	   <tr><th>phone:</th><td><input type="text" name="phone" value="<%=phone%>"></td> 
	   <tr><th>E-mail:</th><td><input type="text" name="mail" value="<%=mail%>"></td>
       <tr><th>Problem:</th><td><textarea rows="3" cols="20" name="problem"></textarea></td> 
	   <tr><td><td><input type="submit" name="SEND"></td></td></tr> 
	    <%}
	 	%>
...
<div class="art-content-layout layout-item-1">
  ...
  <div class="art-layout-cell layout-item-3" style="width:50%;">
        <p><img width="230" height="166" alt="" src="./images/Central.jpg" /><br /></p>
    </div>
	<div class="art-layout-cell layout-item-3" style="width:50%;">
        <p><img width="230" height="166" alt="" src="./images/Central.jpg" /><br /></p>
    </div>
