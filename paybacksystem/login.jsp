            ...
            <div class="art-nav-outer">
	          <ul class="art-hmenu">
		       <li><a href="index.html" class="active">Home</a></li>
                <li><a href="shoponline.jsp" class="active">Shop Line</a></li>	
...
<div class="art-content-layout">
                   ...
                   <font size="3" color="blue">&nbsp;&nbsp;&nbsp;PERSONAL DETAILS</font>
         <form method="post" name="f"  >
	     <label>First Name:</label>&nbsp;<input type="text" name="fname" /></br></br>
		 <label>Last Name:</label>&nbsp;<input type="password" name="lname" /></br></br>
	     <label>DateofBirth:</label><input type="text" name="cid"  /></br></br>
		 <label>Gender:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select  name="gender" ><option value="male">MALE</option>
		 <option value="female">FEMALE</option></select></br></br>
		 <label>Address:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea name="address" ></textarea></br></br>
		 <label>Pin:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="pin" ></br></br>
		 <label>Phone:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="phone" ></br></br>
		 <label>E-Mail:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="mail" ></br></br>
