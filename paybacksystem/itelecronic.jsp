...
<div class="art-content-layout layout-item-1">
	...
	<%
	  ...
	  session.setAttribute("CMR","cmr central");
	%>
	...
	<% image="./images/cam1.jpg";
	   ...
	   points="200";%>
        ...
        <a href="poductsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
		<img width="180" height="122" alt="" src="./images/cam1.jpg" /></a>
		 summary:</br>
		   product  : camera</br>
		   cost     :20000</br>
		   warrenty :2 years</br>
	...
	<% image="./images/comp2.jpg";
	   ...
	   points="300";%>
        ...
        <a href="poductsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
        <img width="180" height="122" alt="" src="./images/comp2.jpg" /></a>
		 summary:</br>
		   product  : computer</br>
		   cost     :30000</br>
		   warrenty :1 year </br>
	...
	<% image="./images/comp1.jpg";
	   proname="personal computers";
	   pcost="18000";
	   warrenty="6 months";
	   points="180";%>
		   
        <a href="poductsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
            <img width="180" height="122" alt="" src="./images/comp1.jpg" /></a>
		 summary:</br>
		   product  :</br>
		   cost     :18000</br>
...
<div class="art-content-layout layout-item-1">
	...
	<% image="./images/sound.jpg";
	 ...
	 %>
        ...
        <a href="poductsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
        <img width="180" height="122" alt="" src="./images/sound.jpg" /></a></br>
		 summary:</br>
		   product  : Speakers</br>
		   cost     :3000</br>
		   warrenty :6 months</br>
	...
	<% image="./images/earphones.jpg";
	   ...
	   points="10";%>
	   <a href="poductsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
       <img width="180" height="122" alt="" src="./images/earphones.jpg" /></a>
		 summary:</br>
		   product  : EarPhones</br>
		   cost     :1000</br>
		   warrenty :6 months</br>
		   points   :10</br>
	...
	<% image="./images/ipad.jpg";
	   ...
	   points="200";%>
	  <a href="poductsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
      <img width="180" height="122" alt="" src="./images/ipad.jpg" /></a></br>
		 summary:</br>
		   product  : Ipad</br>
		   cost     :20000</br>
		   warrenty :3 years</br>
	...
	<% image="./images/camera.jpg";
	   proname="Vedio camera";
	   pcost="30000";
	   warrenty="2 years";
	   points="300";%>
	   <a href="poductsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
       <img width="180" height="122" alt="" src="./images/camera.jpg" /></a></br>
		 summary:</br>
		   product  :  video Camera</br>
		   cost     :30000</br>
		   warrenty :2 years</br>
		   points   :300</br>
...
<div class="art-content-layout layout-item-1">
	...
	<% image="./images/player.jpg";
	   ...
	   points="20";%>
	  <a href="poductsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
      <img width="180" height="122" alt="" src="./images/player.jpg" /></a></br>
		 summary:</br>
		   product  :CD Player</br>
		   cost     :2000</br>
		   warrenty :6 months</br>
		   points   :20</br>
	...
	<% image="./images/tv2.jpg";
	   ...
	   points="150";%>
	   <a href="poductsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
       <img width="180" height="122" alt="" src="./images/tv2.jpg" /></a></br>
		 summary:</br>
		   product  :Samsung TV</br>
		   cost     :15000</br>
		   warrenty :1 year</br>
		   points   :150</br>
	   ...
	   points="4";%>
	  <a href="poductsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
      <img width="180" height="122" alt="" src="./images/mouse3.jpg" /></a></br>
		 summary:</br>
		   product  :MOuse</br>
		   cost     :400</br>
		   warrenty :6 months</br>
	   ...
	   points="15";%>
	   <a href="poductsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
      <img width="180" height="122" alt="" src="./images/watch.jpg" /></a></br>
		
		 summary:</br>
		   product  :Titan Watch</br>
		   cost     :1500</br>
		   warrenty :6 months</br>
		   points   :15</br>
