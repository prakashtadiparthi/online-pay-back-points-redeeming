...
<div id="art-main">
  <div class="cleared reset-box"></div>
    <div class="art-box art-sheet">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	POINTS DETAILS</font>           
                         <table border="1">
	<tr><th>company name</th><th>Product Name</th><th>Product Cost</th><th>warrenty</th><th>Points</th>
	<th>Pay card Number</th>
	<th>Bank</th><th>Pin Number</th></tr>
	<%
	String point="",prodname="",pcost="",cardnum="",pin="",comname="",bank="";int points=0;
	String warrenty="";
  String cardno=(String)session.getAttribute("CARDNO");
  ResultSet rs=st.executeQuery("select * from earnpoints where custid='"+cardno+"' ");
   while(rs.next())
     {
	   comname=rs.getString(1);
	   prodname=rs.getString(2);
	   pcost=rs.getString(3);
	   warrenty=rs.getString(4);
       point=rs.getString(5);
	   points+=Integer.parseInt(point);
	   cardnum=rs.getString(6);
	   bank=rs.getString(7);
	   pin=rs.getString(8);
	%>
	  <tr>
	 ...
	 <%}
  %>
   <tr><th>TOTAL POINTS:</th><td><td><td><%=points%></td></td></td></tr>
  </table>		
