...
<div class="art-content-layout layout-item-1">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 15%;">
     <p><img width="124" height="174" alt="" src="./images/aaa.jpg" /><br /></p>
	...
	<%
	 ...
	 st.executeUpdate("insert into offer values("+cardnum+","+pin+","+points+",'"+offer+"')");
	 st.executeUpdate("delete from pointdetails where cardno="+cardnum+"");
	 
	%>
      <font size="5" color="blue">OFFER SEND SUCCESSFULLY</font>     
    </div>
