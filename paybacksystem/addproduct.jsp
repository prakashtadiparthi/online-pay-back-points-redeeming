             ...
             <div class="art-layout-wrapper">
                ...
                <div class="art-box art-vmenublockcontent">
                    <div class="art-box-body art-vmenublockcontent-body">
                     ...
                     <form method="post" name="f" action="productadded.jsp" onsubmit="return check()">
				<table>
				<%
				 String comname1="";
				...
				%>
				  <tr><td>CompanyName:</td><td><%=comname1%></td></tr>
	   		      <tr><td>productName:</td><td><input type="text" name="prodname" size="16"></td></tr>
	 		      <tr><td>productCost:</td><td><input type="text" name="prodcost" size="16" ></td></tr>
				  <tr><td>warrenty:</td><td><input type="text" name="warrenty" size="16" ></td></tr>
	    		
	    		  <tr><td>Points:</td><td><input type="text" name="points" size="16" ></td></tr>
				  <tr><td>uploadimage:</td><td><input type="file" name="image"></td></tr>
