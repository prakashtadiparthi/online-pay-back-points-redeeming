...
<div id="art-main">
  <div class="cleared reset-box"></div>
    ...
    <div class="art-box-body art-block-body">
				...
				<p><label>please enter your pin number:</label><input tpye="text" name="pin"><input type="submit" value="show"></br></p>      
                </form>
				<%
				String cardno="";
				String pin=request.getParameter("pin");
				ResultSet rs=st.executeQuery("select paycardid from users where pin="+pin+" ");
				while(rs.next())
				{
				cardno=rs.getString(1);
				%>
				<font size="4" color="blue">pay carn number is:<%=cardno%></font>
                ...
                <p><img width="354" height="184" alt="" src="images/sss.jpg"/></a></br>
	</p>  
...
<div class="art-content-layout layout-item-1">
	...
	<img width="354" height="144" alt="" src="images/image26.jpg"/></a></br></p>
