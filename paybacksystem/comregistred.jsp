...
<div class="art-box art-block">
    <div class="art-box-body art-block-body">
				...
				<%
String res="",uname="",pwd="",cid="",cname="",pid="",pname="",address="",phone="",mail="";
...
mail=request.getParameter("mail");
	st.executeUpdate("insert into company values('"+uname+"','"+pwd+"','"+cid+"','"+cname+"','"+pid+"','"+pname+"','"+address+"',"+phone+",'"+mail+"')");
	st.executeUpdate("insert into newcompany values('"+cname+"','"+pid+"','"+pname+"')");
%>
             
	<font size="4" color="blue">REGISTRATION COMPLETED SUCCESSFULLY</font>		
		    </div>
...
<div class="art-content-layout layout-item-1">
    ...
    <div class="art-layout-cell layout-item-3" style="width: 60%;">
        <p><img width="350" height="162" alt="" src="./images/bigbazaar-2.jpg" /><span style="color: rgb(46, 61, 76);"><br /></span></p>
    </div>
...
<div class="art-content-layout layout-item-1">
    <div class="art-content-layout-row">
    <div class="art-layout-cell layout-item-3" style="width: 60%;">
        <p><img width="350" height="252" alt="" src="./images/Central.jpg" /><span style="color: rgb(46, 61, 76);"><br /></span></p>
    </div>
