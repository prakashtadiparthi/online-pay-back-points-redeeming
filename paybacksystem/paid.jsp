...
<div class="art-box art-block">
    <div class="art-box-body art-block-body">
		 ...
		 String comid=request.getParameter("cid").trim();
		 String comname=request.getParameter("cname").trim();
		 
		 String amount=request.getParameter("amount").trim();
		 
		 st.executeUpdate("insert into payments values('"+comid+"','"+comname+"',"+amount+")");
		 %>
	    <font size="5" color="blue">PAID SUCCESSFULLY</font> 				
