...
<table><tr><th>Card No</th><th>Pin No</th><th>Points</th></tr>

<%
                int c=0,i=0;
                ResultSet rs1=st.executeQuery("select count(*) as c from pointdetails ");
                  if(rs1.next())
                  c=rs1.getInt("c");
                 
       	          String s[][]=new String[c][4];
                  rs1.close();
                 ResultSet rs=st.executeQuery("select * from pointdetails ");
                while(rs.next())
                {
                    ...
                    for(i=0;i<c;i++)
                      {
                       %>
                         ...
                         <td><%=s[i][1]%></td>
			             <td><%=s[i][2]%></td>
		         <td><a href="offerdetail.jsp?cardno=<%=s[i][0]%>&pin=<%=s[i][1]%>&points=<%=s[i][2]%>"><font color="red">OFFER</a></td>
                          </tr>
                       <%}            
                        %>		
    </table>       
    <div class="art-layout-cell layout-item-2" style="width: 35%;">
	<p><img width="300" height="164" alt="" src="./images/images17.jpg" /><br /></p>
		
	 </div>
	<div class="art-layout-cell layout-item-2" style="width: 35%;">
	<p><img width="300" height="164" alt="" src="./images/images18.jpg" /><br /></p>
...
<div class="art-content-layout layout-item-1">
	...
	<div class="art-layout-cell layout-item-2" style="width: 35%;">
	<p><img width="284" height="164" alt="" src="./images/images19.jpg" /><br /></p>
