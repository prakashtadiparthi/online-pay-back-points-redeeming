...
<table><tr><th>Card No</th><th>Pin No</th><th>Points</th><th>Offer Details</th></tr>

<% 
String cardno=(String)session.getAttribute("CARDNO");
ResultSet rs=st.executeQuery("select * from offer where cardno="+cardno+""); 
while(rs.next())
{%>
<tr>
...
<%}%>       
	...
	<p><img width="284" height="164" alt="" src="./images/payback5.jpg" /><br /></p>
...
<div class="art-content-layout layout-item-1">
	...
	<div class="art-layout-cell layout-item-2" style="width: 35%;">
	<p><img width="324" height="164" alt="" src="./images/images36.jpg" /><br /></p>
