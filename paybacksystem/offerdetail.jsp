...
<div class="art-post-inner art-article">
                                <h2 class="art-postheader">OFFER DETAILS
                                </h2>
<div class="art-postcontent">
<div class="art-content-layout-wrapper layout-item-0">
<div class="art-content-layout layout-item-1">
         
<form action="offersubmission.jsp" method="post" name="f" onsubmit="return check()">   
<table border="1">
<%  
   String cardno="",pinno="",points="";
   cardno=request.getParameter("cardno"); 
   out.print(cardno);
   pinno=request.getParameter("pin");
   points=request.getParameter("points");
   %>
   <tr><th>Card NO:</th><td><input type="text" name="cardno" value="<%=cardno%>"></td></tr>
   <tr><th>Pin NO:</th><td><input type="text" name="pin" value="<%=pinno%>"></td></tr>
   <tr><th>Points:</th><td><input type="text" name="points" value="<%=points%>"></td></tr>
   <tr><th>Offer Details:</th><td><textarea rows="3" cols="17" name="offer"></textarea></td></tr>
   <tr><td><td><input type="submit" value="SEND"></td></td></tr>
 		</table>	
</form>	
<div class="art-layout-cell layout-item-2" style="width: 35%;">
	<p><img width="300" height="164" alt="" src="./images/images8.jpg" /><br /></p>
		
	 </div>	
	<div class="art-layout-cell layout-item-2" style="width: 35%;">
	<p><img width="300" height="164" alt="" src="./images/images11.jpg" /><br /></p>
...
<div class="art-content-layout layout-item-1">
	...
	<div class="art-layout-cell layout-item-2" style="width: 35%;">
	<p><img width="284" height="164" alt="" src="./images/images12.jpg" /><br /></p>
