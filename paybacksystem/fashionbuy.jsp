...
<div class="art-content-layout layout-item-1">
	...
	%>
        <a href="itpoductbuy.jsp"><img width="180" height="122" alt="" src="<%=images%>" /></a></br>
		 summary:</br>
		   product  : <%=prodname%></br>
		   cost     :<%=pcost%></br>
		   warrenty   :<%=warrenty%></br>
		   
		   points   :<%=points%></br>
		   <form method="post" name="f" action="fashionbuyed.jsp?prodname=<%=prodname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
		   <label><font size="3" color="blue">select type of Bank:</font>
		    <select name="banks">
			<option value"sbibank">SBI</option>
		   ...
		   <label><font size="3" color="blue">Atm pin number:</font></label>
		   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="pin" size="20"/>
		   <input type="submit" value="shop now"/>
		   </form>
    </div>
	<div class="art-layout-cell layout-item-2" style="width: 40%;">
	<img width="360" height="178" alt="" src="./images/prod.jpg" /></br>
