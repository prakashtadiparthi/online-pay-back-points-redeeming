...
<div class="art-post-inner art-article">
         <h2 class="art-postheader">GIFT ARTICALS
                                </h2>
...
<div class="art-content-layout layout-item-1">
	...
	<%
	  ...
	  String warrenty="";
	  String points="";
	  session.setAttribute("BIGBAZAR","bigbazar");
	  %>
	<div class="art-layout-cell layout-item-2" style="width: 20%;">
	<% image="./images/gift1.jpg";
	   proname="plastic things";
	   pcost="5000";
	   warrenty="6 months";
	   points="50";%>
		   
        <a href="giftsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
        <img width="180" height="122" alt="" src="./images/gift1.jpg" /></a>
		 summary:</br>
		   product  : Plastic Things set</br>
		   cost     :5000</br>
	   ...
	   points="4";%>
		<a href="giftsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
    <img width="180" height="122" alt="" src="./images/gift2.jpg" /></a>
		 summary:</br>
		   product  : Elephent</br>
		   cost     :400</br>
		   warrenty :2 months</br>
		   points   :4</br>
	...
	<% image="./images/gift3.jpg";
	   ...
	   points="6";%>
	   <a href="giftsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
       <img width="180" height="122" alt="" src="./images/gift3.jpg" /></a>
		 summary:</br>
		   product  :Little Baby</br>
		   cost     :600</br>
		   warrenty :6 months</br>
		   points   :6</br>
...
<div class="art-content-layout layout-item-1">
	...
	<% image="./images/gift4.jpg";
	   proname="Golden things";
	   pcost="800";
	   warrenty="6 months";
	   points="8";%>
	   <a href="giftsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
       <img width="180" height="122" alt="" src="./images/gift4.jpg" /></a></br>
		 summary:</br>
		   product  : Golden things</br>
		   cost     :800</br>
		   warrenty :6 months</br>
		   points   :8</br>
	...
	<% image="./images/gift5.jpg";
	   proname="silver Articles";
	   pcost="7000";
	   warrenty="1 year";
	   points="70";%>
	   <a href="giftsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
       <img width="180" height="122" alt="" src="./images/gift5.jpg" /></a>
		 summary:</br>
		   product  : Silver Articles</br>
		   cost     :7000</br>
		   warrenty :1 year </br>
		   points   :70</br>
	...
	<% image="./images/gift6.jpg";
	   ...
	   points="2";%>
	  <a href="giftsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
      <img width="180" height="122" alt="" src="./images/gift6.jpg" /></a></br>
		 summary:</br>
		   product  : Peacock </br>
		   cost     :200</br>
		   warrenty :6 months</br>
	...
	<% image="./images/gift7.jpg";
	   ...
	   points="3";%>
	   <a href="giftsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
       <img width="180" height="122" alt="" src="./images/gift7.jpg" /></a></br>
		 summary:</br>
		   product  : Hasma </br>
		   cost     :300</br>
		   warrenty :6 months</br>
...
<div class="art-content-layout layout-item-1">
	...
	<% image="./images/gift8.jpg";
	   proname="silver things";
	   pcost="1000";
	   warrenty="1 year";
	   points="10";%>
	   <a href="giftsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
       <img width="180" height="122" alt="" src="./images/gift8.jpg" /></a></br>
		 summary:</br>
		   product  :silver Things</br>
		   cost     :1000</br>
		   warrenty :1 year</br>
		   points   :10</br>
	...
	<% image="./images/gift9.jpg";
	   ...
	   points="12";%>
	   <a href="giftsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
       <img width="180" height="122" alt="" src="./images/gift9.jpg" /></a></br>
		 summary:</br>
		   product  :Watch</br>
		   cost     :1200</br>
		   warrenty :1 year</br>
		...
		<div class="art-layout-cell layout-item-2" style="width: 20%;">
		<% image="./images/gift10.jpg";
	   proname="Lord Ganesh";
	   pcost="1000";
	   warrenty="6 months";
	   points="10";%>
	   <a href="giftsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
      <img width="180" height="122" alt="" src="./images/gift10.jpg" /></a></br>
		 summary:</br>
		   product  :Lord Ganesh</br>
		   cost     :1000</br>
		   warrenty :6 months</br>
		   points   :10</br>
		...
		<div class="art-layout-cell layout-item-2" style="width: 20%;">
		<% image="./images/gift11.jpg";
	   proname="lights";
	   pcost="400";
	   warrenty="6 months";
	   points="4";%>
	   <a href="giftsbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
       <img width="180" height="122" alt="" src="./images/gift11.jpg" /></a></br>
		 summary:</br>
		   product  :lights</br>
		   cost     :400</br>
		   warrenty :6 months</br>
