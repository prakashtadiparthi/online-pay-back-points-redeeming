...
<div class="art-content-layout layout-item-1">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 15%;">
      <p><img width="124" height="174" alt="" src="./images/images13.jpg" /><br /></p>
	  </div>
	
	<div class="art-layout-cell layout-item-2" style="width: 45%;">
	<%
	   String comname1="";
	   String comname=(String)session.getAttribute("USER1");
	   ResultSet rs1=st.executeQuery("select copanyname from company where uname ='"+comname+"'");
		while(rs1.next())
		 {
		  comname1=rs1.getString(1);
         }		
	   String prodname="",prodcost="",points="",image="",warrenty="";
	   prodname=request.getParameter("prodname");
	   prodcost=request.getParameter("prodcost");
	   warrenty=request.getParameter("warrenty");
	   points=request.getParameter("points");
	   image=request.getParameter("image");
	   st.executeUpdate("insert into products values('"+comname1+"','"+prodname+"','"+prodcost+"','"+warrenty+"',"+points+",'"+image+"')");
	 %>				
      <font size="4" color="blue">PRODUCT ADDED SUCCESSFULLY</font>     
    </div>
