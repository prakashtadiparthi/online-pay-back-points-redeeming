	...
	%>
        <a href="itpoductbuy.jsp"><img width="180" height="122" alt="" src="<%=images%>" /></a></br>
		 summary:</br>
		   ...
		   points   :<%=points%></br>
		   <form method="post" name="f" action="giftsbuyed.jsp?prodname=<%=prodname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
		   ...
		   <label>
		  <font size="3" color="blue">Atm pin number:</font></label>
