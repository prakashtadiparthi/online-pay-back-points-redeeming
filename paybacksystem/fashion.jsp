...
<div class="art-post-inner art-article">
                                <h2 class="art-postheader">FASHION PRODUCTS                                </h2>
...
<div class="art-content-layout layout-item-1">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 15%;">
      <p><font size="3" color="red">Shop Online</font></p>
		...
		<%
		  String comname="";
		  ResultSet rs=st.executeQuery("select prodname  from newcompany");
		  while(rs.next())
		  {
		   comname=rs.getString(1);
		  %>
		  <a href="<%=comname%>.jsp">>&nbsp;&nbsp;&nbsp;<%=comname%></a></br>
		 <% }
		%>
    </div>
	<%
	   ...
	   String warrenty="";
	   String points="";
	   session.setAttribute("HOME TOWN","home town");
	  %>
	<div class="art-layout-cell layout-item-2" style="width: 20%;">
	<% image="./images/fas1.jpg";
	   proname="black formal shirts";
	   pcost="799";
	   warrenty="1 year";
	   points="8";%>
		   
        <a href="fashionbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
        <img width="180" height="122" alt="" src="./images/fas1.jpg" /></a>
		 summary:</br>
		   product  : Black formal shirt</br>
		   cost     :799</br>
		   warrenty :1 year</br>
		   points   :8</br>
	...
	<% image="./images/belt.jpg";
	   ...
	   points="2";%>
        ...
        <a href="fashionbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
        <img width="180" height="122" alt="" src="./images/belt.jpg" /></a>
		 summary:</br>
		   product  : Belt </br>
		   cost     :200</br>
		   warrenty :6 months</br>
		   points   :12</br>
	...
	<% image="./images/tshirt.jpg";
	   ...
	   points="12";%>
	  <a href="fashionbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
      <img width="180" height="122" alt="" src="./images/tshirt.jpg" /></a>
		 summary:</br>
		   product  :tshirt</br>
		   cost     :1200</br>
		   warrenty :18 months</br>
		   points   :12</br>
...
<div class="art-content-layout layout-item-1">
	...
	<% image="./images/wat.jpg";
	   proname="Ladies watch";
	   pcost="800";
	   warrenty="1 year";
	   points="8";%>
		   
        <a href="fashionbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
    <img width="180" height="122" alt="" src="./images/wat.jpg" /></a></br>
		 summary:</br>
		   product  : Ladies Watch</br>
		   cost     :800</br>
		   warrenty :1 year</br>
		   points   :8</br>
	...
	<div class="art-layout-cell layout-item-2" style="width: 20%;">
	<% image="./images/fas2.jpg";
	   proname="off hand shird";
	   pcost="400";
	   warrenty="1 year";
	   points="4";%>
	   <a href="fashionbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
       <img width="180" height="122" alt="" src="./images/fas2.jpg" /></a>
		 summary:</br>
		   product  : Off Hand Shirt</br>
		   cost     :400</br>
		   warrenty :1 year</br>
		   points   :4</br>
	...
	<% image="./images/fas3.jpg";
	   ...
	   points="3";%>
	   <a href="fashionbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
      <img width="180" height="122" alt="" src="./images/fas3.jpg" /></a></br>
		 summary:</br>
		   product  : Mens Wear</br>
		   cost     :300</br>
		   warrenty :6 months</br>
		   points   :3</br>
	...
	<% image="./images/download.jpg";
	   ...
	   points="10";%>
	   <a href="fashionbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
       <img width="180" height="122" alt="" src="./images/download.jpg" /></a></br>
		 summary:</br>
		   product  : Ladies wear</br>
		   cost     :1000</br>
		   warrenty :1 year</br>
		   points   :10</br>
...
<div class="art-content-layout layout-item-1">
	...
	<% image="./images/fas4.jpg";
	   proname="mens foot wear";
	   pcost="1500";
	   warrenty="18 years";
	   points="15";%>
	    <a href="fashionbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
        <img width="180" height="122" alt="" src="./images/fas4.jpg" /></a></br>
		 summary:</br>
		   product  :Mens Foot Wear</br>
		   cost     :1500</br>
		   warrenty :18 months</br>
		   points   :15</br>
	...
	<%image="./images/wat2.jpg";
	   ...
	   points="6";%>
        ...
        <a href="fashionbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
        <img width="180" height="122" alt="" src="./images/wat2.jpg" /></a></br>
		 summary:</br>
		   product  :Ladies Watch</br>
		   cost     :600</br>
		   warrenty :6 months</br>
		...
		<div class="art-layout-cell layout-item-2" style="width: 20%;">
		<%image="./images/fas5.jpg";
	   proname="mens shoes";
	   pcost="2000";
	   warrenty="2 years";
	   points="20";%>
	   <a href="fashionbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
       <img width="180" height="122" alt="" src="./images/fas5.jpg" /></a></br>
		 summary:</br>
		   product  :Mens Shoes</br>
		   cost     :2000</br>
		   warrenty :2 years</br>
		   points   :20</br>
	   ...
	   proname="Ladies ear rings";
	   pcost="200";
	   warrenty="4 months";
	   points="2";%>
	
        <a href="fashionbuy.jsp?images=<%=image%>&proname=<%=proname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
        <img width="180" height="122" alt="" src="./images/lady.jpg" /></a></br>
		 summary:</br>
		   product  :Lady ear Rings</br>
		   cost     :200</br>
		   warrenty :4 months</br>
		   points   :2</br>
