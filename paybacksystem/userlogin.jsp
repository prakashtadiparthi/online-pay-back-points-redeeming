...
<head>
	...
	function check()
	  {
	    var pid=document.f1.pid.value;
		if(pid=="")
		{
		 alert("pay card number should not be empty!");
		 return false;
		}
	  else
	  return true;
...
<div class="art-box art-block">
    <div class="art-box-body art-block-body">
				...
				<label><font  size="2" color="red">We don't have a payback card</font></label></br></br>
				<label>click here to get pay back card&nbsp;&nbsp;<a href="login1.jsp">JOIN NOW</a></label>								
                </div>
                <div class="art-box art-blockcontent">
                    <div class="art-box-body art-blockcontent-body">
                <p></p>

<p>	<marquee direction="down">Earning PAYBACK points is easy! Carry your PAYBACK card in your wallet and use your PAYBACK card during payment whenever you shop at a partner.
 You’ll see, it pays!</marquee></p><br />                
...
<div class="art-content-layout layout-item-1">
	...
	<font size="2" color="red">Please enter PAYBACK/i-mint card number to Login</font></br></br>
	   <form method="post" name="f1" action="userloginvalidation.jsp" onsubmit="return check()">
		    <label>pay back card number:</label>
			<input type="text" name="pid" size="20"/></br></br>
		    <input type="submit" value="LOG IN"/>
		</form>
		</br>
		</br>
		</br>
        <a href="paybackno.jsp"><font size="2" color="blue">>>where i can find my pay back card number</font></a>
		</br>
		</br>
    </div>
    </div>
