          ...
          <div class="cleared reset-box"></div>
           <div class="art-bar art-nav">
            <div class="art-nav-outer">
	          <ul class="art-hmenu">
		        <li><a href="userhome.jsp" class="active">Home</a>
			        <ul><li><a href="./new-page/new-page.html">Subpage 1</a></li>
                ...
                <li><a href="information.jsp" class="active">Information</a></li>	
...
<div class="art-content-layout layout-item-1">
	...
	<%
	 ...
	 String images=request.getParameter("images").trim();
	 String prodname=request.getParameter("proname").trim();
	 String pcost=request.getParameter("pcost").trim();
	 String points=request.getParameter("points").trim();
	
	%>
        <img width="180" height="122" alt="" src="<%=images%>" /></br>
		 summary:</br>
		   product  : <%=prodname%></br>
		   cost     :<%=pcost%></br>
		   points   :<%=points%></br>
		   <form method="post" name="f" action="itproductbuyed.jsp?prodname=<%=prodname%>&pcost=<%=pcost%>&warrenty=<%=warrenty%>&points=<%=points%>">
		   <label><font size="3" color="blue">Enter your pin number:</font></label><input type="text" name="pin" size="20"/><input type="submit" value="shop now"/>
		   </form>
		   
    </div>
	<div class="art-layout-cell layout-item-2" style="width: 40%;">
	<img width="360" height="178" alt="" src="./images/prod.jpg" /></a></br>
		...
		<div class="cleared"></div>
            ...
            <div class="cleared"></div>
			<font size="5" color="pink">Thank u visiting</font>
