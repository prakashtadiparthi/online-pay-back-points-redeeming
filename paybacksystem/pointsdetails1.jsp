...
<div id="art-main">
  <div class="cleared reset-box"></div>
    <div class="art-box art-sheet">
          ...
          <div class="cleared reset-box"></div>
           <div class="art-bar art-nav">
            <div class="art-nav-outer">
	          <ul class="art-hmenu">
		        <li><a href="comhome.html" class="active">Home</a></li>
                ...
                <li><a href="pointsdetails1.jsp" class="active">POINTS DETAILS</a></li>
		...
		POINTS DETAILS</font>           
                         <table border="1">
	<tr><th>Company Name</th><th>Card Number</th><th>Pin Number</th><th>Tot Points</th></tr>
	<%
