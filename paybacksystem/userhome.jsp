                        ...
                        <div class="art-layout-cell art-sidebar1">
                           <div class="art-box art-vmenublock">
                               <div class="art-box-body art-vmenublock-body">
                                ...
                                <p><img src="images/bazzar.jpg" width="200" height="180"></p>
                </div>
...
<div class="art-box art-block">
    <div class="art-box-body art-block-body">
                ...
                <p><marquee direction="up"><img width="168" height="202" alt="" src="./images/cust.jpg" /></marquee></p>                
...
<div class="art-post-inner art-article">
                                <h2 class="art-postheader">Wel come to customer home page
                                </h2>
...
<div class="art-content-layout layout-item-1">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%;">
        <p><img src="./images/points1.jpg" alt="an image" id="preview-image" name="preview-image" width="213" height="132" />
        <img src="./images/dfdf.jpg" alt="an image" id="preview-image" name="preview-image" width="213" height="132" />
		 <img src="./images/central1.jpg" alt="an image" id="preview-image" name="preview-image" width="213" height="132" />
        </p>
...
<div class="art-content-layout layout-item-1">
    ...
    <div class="art-layout-cell layout-item-3" style="width: 33%;">
        <p><img width="207" height="136" alt="" src="./images/prod.jpg" /><span style="color: rgb(46, 61, 76);"><br /></span></p>
    </div><div class="art-layout-cell layout-item-2" style="width: 34%;">
        <img width="207" height="142" alt="" src="./images/earn.jpg" />
    </div><div class="art-layout-cell layout-item-3" style="width: 33%;">
        <p><img width="217" height="136" alt="" src="./images/earn2.jpg" /><br /></p>
    </div>
    </div>
</div>
</div>
...
<div class="art-content-layout layout-item-1">
    <div class="art-content-layout-row">
    <div class="art-layout-cell layout-item-2" style="width: 90%;">
        <p><a href="index.html"><img width="429" height="120" alt="" src="./images/htcard1.jpg" /></a>       
		  <img width="209" height="129" alt="" src="./images/home.jpg" /><br /></p>
    </div>
    </div>
</div>
</div>
